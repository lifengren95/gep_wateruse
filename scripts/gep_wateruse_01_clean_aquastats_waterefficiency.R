...
output_dir <- here("Data/intermediate/aquastat_cleaned")
...
auqastat_water_efficiency <- 
  fread(
    file = here("Data/raw/aquastat/aquastat_water_efficiency.csv"), 
    fill = TRUE
  )
...
# Save data
fwrite(auqastat_wide, here(output_dir,"aquastats_cleaned.csv"))
